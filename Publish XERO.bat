...
echo ============================================
echo.
REM OneDrive locks .git files, so disable ALL of Git's auto housekeeping (prevents the "Deletion failed (y/n)" hang)
...
if exist ".git\gc.log" del /f /q ".git\gc.log" >nul 2>nul
